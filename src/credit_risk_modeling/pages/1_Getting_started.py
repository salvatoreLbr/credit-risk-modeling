...
get_probability_density_function_chart(distribution_value=s, plot_chart=True, vertical_line_dict=vertical_line_dict)

st.markdown("And now see this chart:")
get_cumulative_distribution_function_chart(distribution_value=s, plot_chart=True, vertical_line_dict=vertical_line_dict)
